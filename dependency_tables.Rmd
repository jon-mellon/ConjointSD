...
if (!requireNamespace("igraph", quietly = TRUE)) {
  stop("Package 'igraph' is required to plot the dependency DAG.")
}
...
if (is.null(edges) || nrow(edges) == 0) {
  ...
  g <- igraph::graph_from_data_frame(edges, vertices = theorems, directed = TRUE)
  layout <- tryCatch(
  ...
  plot(
    g,
    layout = layout,
    vertex.label = pretty_name(igraph::V(g)$name),
    vertex.size = 12,
