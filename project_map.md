...
- [ConjointSD/Defs.lean](readable/Defs.md) centralizes core definitions used across the project ([population](readable/jargon_population.md)/empirical moments, [plug-in](readable/jargon_plug_in.md) scores, [OLS](readable/jargon_ols.md) helpers, and conjoint primitives).
...
- [ConjointSD/PredictedSD.lean](readable/PredictedSD.md) defines empirical/[population](readable/jargon_population.md) [mean](readable/jargon_mean.md), [second moment](readable/jargon_second_moment.md), [variance](readable/jargon_variance.md), and [SD](readable/jargon_standard_deviation.md) for a real-valued process; proves [LLN](readable/jargon_lln.md)-based [consistency](readable/jargon_consistency.md) `sdHatZ -> popSDZ`.
