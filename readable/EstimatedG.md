...
- `GEstimationAssumptions` is the main assumption package. It says the [population](jargon_population.md) [mean](jargon_mean.md) and [second moment](jargon_second_moment.md) of the [plug-in](jargon_plug_in.md) score [converge](jargon_convergence.md) to the population values of the true score.
...
- Using [continuity](jargon_continuity.md) of the square root, it then derives [convergence](jargon_convergence.md) of the population [standard deviation](jargon_standard_deviation.md).
