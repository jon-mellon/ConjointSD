...
This file formalizes what happens when you replace a true score function `g theta0` with an estimated one `g (theta_hat n)`. It now uses `IsProbabilityMeasure` instead of standalone probability-measure hypotheses.
