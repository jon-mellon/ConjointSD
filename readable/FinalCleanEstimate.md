...
Key definitions:
- `meanPlugIn`, `m2PlugIn`, `varPlugIn`, `sdPlugIn` are the plug-in population [mean](jargon_mean.md), [second moment](jargon_second_moment.md), [variance](jargon_variance.md), and [standard deviation](jargon_standard_deviation.md) when you use the estimated parameter at step `n`.
