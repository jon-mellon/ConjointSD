...
What it assumes:
- A score function `g` depends on a parameter `theta`.
...
The key idea is simple: continuity plus [convergence](jargon_convergence.md) of parameters gives convergence of the population functionals.
