...
Key definition:
- `gPaper` is the score function defined by the paper's regression terms (intercept, main effects, [interactions](jargon_interaction.md)). It uses the [linear model](jargon_linear_model.md) setup.
