...
- `PaperOLSLLNA`, `PaperOLSInverseStability`, and `PaperOLSIdentifiability` break the moment package into [LLN](jargon_lln.md) for Gram/cross, inverse stability, and the population normal-equation identity for `theta0`.
...
- `paper_ols_moment_assumptions_of_lln_fullrank_ae` assembles the a.e. moment package from [LLN](jargon_lln.md)-style and inverse-stability assumptions plus the population normal equations.
