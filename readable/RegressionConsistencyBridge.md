...
This file bridges parameter [convergence](jargon_convergence.md) to plug-in moment convergence.

Key definitions:
- `popMeanTheta` and `popM2Theta` treat the population [mean](jargon_mean.md) and [second moment](jargon_second_moment.md) as functions of the parameter.
- `FunctionalContinuityAssumptions` says those functions are continuous at the true parameter.
...
In plain terms: if the parameter estimates settle down and the population moments depend smoothly on the parameter, then plug-in moments [converge](jargon_convergence.md) as needed.
