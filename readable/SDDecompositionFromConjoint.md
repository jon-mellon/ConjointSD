...
- `iidAssumptions_Zcomp` shows that the score process `Zcomp` inherits IID properties from `A`.
...
This file is the bridge from general IID assumptions on the data to [standard deviation](jargon_standard_deviation.md) consistency for scores and blocks.
