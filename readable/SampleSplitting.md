...
Main results:
- `sdHat_fixed_m_tendsto_ae_popSDAttr` says: for fixed `m`, the evaluation-stage [standard deviation](jargon_standard_deviation.md) estimator [converges](jargon_convergence.md) (almost everywhere) to the population SD of the plug-in score under the evaluation [distribution](jargon_distribution.md).
