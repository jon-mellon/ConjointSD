...
This file instantiates the conjoint design for the specific "status" study used in the paper. It now uses `IsProbabilityMeasure` in place of standalone probability-measure hypotheses when defining the concrete distributions.
