...
- `weightVarAttr_eq_popVarAttr_of_moments` and `weightSDAttr_eq_popSDAttr_of_moments` show that if weighted moments match population moments, then weighted variance/SD equals the population variance/SD.
