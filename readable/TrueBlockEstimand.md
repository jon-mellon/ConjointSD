...
Part 2: connect sequential consistency to the true block targets
...
- The assumptions include block-wise continuity, [convergence](jargon_convergence.md) of parameter estimates, and a block-specification equality at `theta0`.
...
In short, the file pins down the "true" block targets and proves that the generic consistency statements can be aimed at those targets.
